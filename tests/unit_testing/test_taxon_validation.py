...
# set profile id attribute before the manifest o ELEVATION, TIME_OF_COLLECTION,
...
#      print(DtolSpreadsheet())bject is create
#
# # pandas.read_excel('tests/manifests/sample_manifest.xlsx', sheet_name='DTOLSAMPLE1.3')
# # # Specimen and whole organism should only ITAT, DEPTH,
...
class DTOLTaxonValidationTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        dtol_manifests_filename = "DTOL_SAMPLE_MANIFESTS.xlsx"
        dtol_sample1_sheetname = 'DTOL_SM1'
        ...
        p_dict = {"copo_id": "000000000", "description": "DTOL Test Description", "user_id": cls.user.id,
    ...
    def test_working_dtol_manifest_validation_and_submission(self):
        ...
        # dtol_sample1_3_worksheet_file = pandas.read_excel(sample_manifest_path,
        # sheet_name=self.dtol_sample_1_3_sheetname)
        dtol_sample1_file = os.path.join(manifests_dir_path, "DTOL_SAMPLE_1.xlsx")
        element.send_keys(dtol_sample1_file)
        ...
        # Find the "Confirm" button in the pop-up dialog CSS class was added
        # for tag purposes in copo_sample_parse_spreadsheet.js file
