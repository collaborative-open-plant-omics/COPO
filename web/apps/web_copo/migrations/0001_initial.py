# Generated by Django 3.1 on 2023-01-26 16:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repo_manager',
                 django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, null=True,
                                                           size=None)),
                ('repo_submitter',
                 django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, null=True,
                                                           size=None)),
