...
POP_GENOMICS_OPTIONAL_COLUMNS_DEFAULT_VALUES_MAPPING = {
    ...
    'BIOBANKED_TISSUE_PRESERVATIVE': '',
    'COLLECTOR_ORCID_ID': '',
    'DATE_OF_PRESERVATION': '',  # Default value is value of 'DATE_OF_COLLECTION' column
    'DESCRIPTION_OF_COLLECTION_METHOD': 'NOT_PROVIDED',
    'DIFFICULT_OR_HIGH_PRIORITY_SAMPLE': 'NOT_PROVIDED',
    'DNA_REMOVED_FOR_BIOBANKING': 'N',
    'DNA_VOUCHER_ID_FOR_BIOBANKING': '',
    'GAL': 'INDUSTRY_PARTNER',
    'GAL_SAMPLE_ID': '',  # Default value is value of 'COLLECTOR_SAMPLE_ID' column
    'IDENTIFIED_BY': 'NOT_PROVIDED',
    'IDENTIFIED_HOW': 'NOT_PROVIDED',
    'IDENTIFIER_AFFILIATION': 'NOT_PROVIDED',
    'LIFESTAGE': 'NOT_COLLECTED',
    'ORGANISM_PART': 'NOT_PROVIDED',
    'PRESERVATION_APPROACH': 'NOT_PROVIDED',
    'PRESERVED_BY': 'NOT_PROVIDED',
    'PRESERVER_AFFILIATION': 'NOT_PROVIDED',
    'SEX': 'NOT_COLLECTED',
    'SIZE_OF_TISSUE_IN_TUBE': 'NOT_PROVIDED',
